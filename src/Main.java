...
public class Main {
	...
	public static void main( String[] args ) throws Exception {
		...
		writeResource("android-sdk/cmake/cmake-3.10.2-android-aarch64.zip", new File(homeDirPath, "android-sdk/cmake/cmake-3.10.2-android-aarch64.zip"));		
		writeResource("android-sdk/cmake/cmake-3.18.1-android-aarch64.zip", new File(homeDirPath, "android-sdk/cmake/cmake-3.18.1-android-aarch64.zip"));		
		writeResource("android-sdk/cmake/cmake-3.22.1-android-aarch64.zip", new File(homeDirPath, "android-sdk/cmake/cmake-3.22.1-android-aarch64.zip"));		
		writeResource("android-sdk/cmake/cmake-3.25.1-android-aarch64.zip", new File(homeDirPath, "android-sdk/cmake/cmake-3.25.1-android-aarch64.zip"));		


		// 复制Ndk
		System.out.println("复制Ndk到安装缓存区...");		
		FileInputStream ndkZipFileInputStream = new FileInputStream(ndkZipFile);
		FileOutputStream ndkZipFileOutputStream = new FileOutputStream(new File(homeDir, String.format("android-ndk-%s-aarch64.zip", NDK_VERSION_NAME)));
		...
		try {
			...
			android.system.Os.symlink(homeDirPath + "/android-sdk/ndk/" + NDK_VERSION_CODE, android_ndk_aide_dir.getAbsolutePath());
